...
export class SittingLeft extends State {
    ...
    handleInput(input) {
        if (input === 'RELEASE down') this.player.setState(states.STANDING_LEFT); // set state to StandingRight
...
export class RunningLeft extends State {
    ...
    handleInput(input) {
        if (input === 'PRESS right') this.player.setState(states.RUNNING_RIGHT);
        if (input === 'RELEASE left') this.player.setState(states.STANDING_LEFT); // set state to StandingRight
        if (input === 'PRESS down') this.player.setState(states.SITTING_LEFT);
    }
}
...
export class RunningRight extends State {
    ...
    handleInput(input) {
        if (input === 'PRESS left') this.player.setState(states.RUNNING_LEFT);
        if (input === 'RELEASE right') this.player.setState(states.STANDING_RIGHT); // set state to StandingRight
        if (input === 'PRESS down') this.player.setState(states.SITTING_RIGHT);
    }
}
